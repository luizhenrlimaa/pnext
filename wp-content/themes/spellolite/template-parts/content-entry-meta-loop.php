...
<?php
	...
	$author_visible = spellolite_is_meta_visible( 'blog_post_author', 'loop' );
?>
...
<div class="entry-meta">
	...
	<div class="entry-meta__data">
		...
		<?php $date_visible = spellolite_is_meta_visible( 'blog_post_publish_date', 'loop' );
		...
		<?php $tags_visible = spellolite_is_meta_visible( 'blog_post_tags', 'loop' );
		...
		<?php $comment_visible = spellolite_is_meta_visible( 'blog_post_comments', 'loop' );
