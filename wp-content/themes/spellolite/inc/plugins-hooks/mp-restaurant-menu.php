...
add_action( 'mprm_shortcode_menu_item_grid', 'spellolite_mprm_menu_item_image_before', 20 );
...
add_action( 'mprm_shortcode_menu_item_grid', 'spellolite_mprm_menu_item_image_after', 35 );
add_action( 'mprm_shortcode_menu_item_grid', 'spellolite_mprm_menu_item_entry_header_before', 40 );
...
add_action( 'mprm_shortcode_menu_item_grid', 'spellolite_mprm_menu_item_entry_header_after', 50 );
add_action( 'mprm_shortcode_menu_item_grid', 'spellolite_mprm_menu_item_main_content_before', 55 );
...
add_action( 'mprm_shortcode_menu_item_grid', 'spellolite_mprm_menu_item_main_content_after', 70 );
...
add_action( 'mprm_shortcode_menu_item_simple-list', 'spellolite_mprm_menu_item_main_content_before', 28 );
...
add_action( 'mprm_shortcode_menu_item_simple-list', 'spellolite_mprm_menu_item_main_content_after', 35 );
...
add_action( 'mprm_shortcode_menu_item_list', 'spellolite_mprm_menu_item_entry_header_before', 23 );
add_action( 'mprm_shortcode_menu_item_list', 'mprm_menu_item_list_price', 28 );
add_action( 'mprm_shortcode_menu_item_list', 'spellolite_mprm_menu_item_entry_header_after', 30 );
add_action( 'mprm_shortcode_menu_item_list', 'spellolite_mprm_menu_item_main_content_before', 33 );
...
add_action( 'mprm_shortcode_menu_item_list', 'spellolite_mprm_menu_item_main_content_after', 43 );
...
add_action( 'mprm_menu_item_content_before', 'spellolite_mprm_menu_item_single_title', 10 );
add_action( 'mprm_menu_item_content_before', 'spellolite_mprm_menu_item_single_image', 20 );

add_action( 'mprm_menu_item_content_after', 'spellolite_mprm_menu_item_share_btns', 10 );
...
add_action( 'mprm_taxonomy_grid', 'spellolite_mprm_single_category_grid_header', 10 );
add_action( 'mprm_taxonomy_grid', 'spellolite_mprm_menu_item_entry_header_before', 38 );
add_action( 'mprm_taxonomy_grid', 'mprm_single_category_grid_price', 43 );
add_action( 'mprm_taxonomy_grid', 'spellolite_mprm_menu_item_entry_header_after', 45 );
add_action( 'mprm_taxonomy_grid', 'spellolite_mprm_menu_item_main_content_before', 47 );
add_action( 'mprm_taxonomy_grid', 'spellolite_mprm_single_taxonomy_excerpt', 50 );
add_action( 'mprm_taxonomy_grid', 'spellolite_mprm_single_taxonomy_attributes', 53 );
add_action( 'mprm_taxonomy_grid', 'spellolite_mprm_menu_item_main_content_after', 55 );

/**
 * Mprm menu-item image html-wrapper before.
 */
function spellolite_mprm_menu_item_image_before() {
 ...
 */
function spellolite_mprm_menu_item_image_after() {
	echo '</figure>';
}
 ...
 */
function spellolite_mprm_menu_item_entry_header_before() {
 ...
 */
function spellolite_mprm_menu_item_entry_header_after() {
	echo '</header>';
}
 ...
 */
function spellolite_mprm_menu_item_main_content_before() {
 ...
 */
function spellolite_mprm_menu_item_main_content_after() {
	echo '</div>';
}
 ...
 */
function spellolite_mprm_menu_item_single_title() {
	spellolite_utility()->utility->attributes->get_title( array(
		'class' => 'mprm-title',
		'html'  => '<h3 %1$s>%4$s</h3>',
		'echo'  => true,
	) );
 ...
 */
function spellolite_mprm_menu_item_single_image() {
	spellolite_utility()->utility->media->get_image( array(
		'size'        => 'spellolite-thumb-l',
		'mobile_size' => 'spellolite-thumb-l',
 ...
 * Print share buttons.
 */
function spellolite_mprm_menu_item_share_btns() {
	spellolite_share_buttons( 'single' );
}

/**
 * Taxonomy header before.
 */
function spellolite_mprm_single_category_grid_header() { ?>
 ...
 * Taxonomy excerpt.
 */
function spellolite_mprm_single_taxonomy_excerpt() {
	spellolite_utility()->utility->attributes->get_content( array (
		'length'       => -1,
 ...
 * Taxonomy attributes.
 */
function spellolite_mprm_single_taxonomy_attributes() {
