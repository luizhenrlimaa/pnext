 ...
 */
add_filter( 'template_include', array( 'Spellolite_Wrapping', 'wrap' ), 99 );
add_filter( 'spellolite_wrap_base', 'spellolite_wrap_base_cpts' );
 ...
 */
function spellolite_template_path() {
	return Spellolite_Wrapping::$main_template;
}
 ...
 */
function spellolite_template_base() {
	return Spellolite_Wrapping::$base;
}

if ( ! class_exists( 'Spellolite_Wrapping' ) ) {
	...
	class Spellolite_Wrapping {
		...
		/**
		 * Initialize new instance of Spellolite_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'spellolite_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Spellolite_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Spellolite_Wrapping();
		}
	}
}
 ...
 */
function spellolite_wrap_base_cpts( $templates ) {
