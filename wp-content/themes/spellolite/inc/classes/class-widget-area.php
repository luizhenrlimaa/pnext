...
if ( ! class_exists( 'Spellolite_Widget_Area' ) ) {

	/**
	 * Class Spellolite_Widget_Area.
	 */
	class Spellolite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'spellolite_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'spellolite_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'spellolite_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function spellolite_widget_area() {
		return Spellolite_Widget_Area::get_instance();
	}

	spellolite_widget_area();
}
