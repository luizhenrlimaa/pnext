 ...
 */
class Spellolite_Builder_Module_Icon extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Icon', 'spellolite' );
		$this->icon = 'f1d8';
	...
	public function get_fields() {
		...
		$fields = array(
			'font_icon' => array(
				'label'               => esc_html__( 'Icon', 'spellolite' ),
				'type'                => 'text',
				'option_category'     => 'basic_option',
				'class'               => array( 'tm-pb-font-icon' ),
				'renderer'            => 'tm_pb_get_font_icon_list',
				'renderer_with_field' => true,
				'description'         => esc_html__( 'Choose an icon to display.', 'spellolite' ),
			),
			'icon_color' => array(
				'label'       => esc_html__( 'Icon Color', 'spellolite' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for your icon.', 'spellolite' ),
			),
			'use_circle' => array(
				'label'           => esc_html__( 'Circle Icon', 'spellolite' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'spellolite' ),
					'on'  => esc_html__( 'Yes', 'spellolite' ),
				),
				'affects'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set above should display within a circle.', 'spellolite' ),
			),
			'circle_color' => array(
				'label'       => esc_html__( 'Circle Color', 'spellolite' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle.', 'spellolite' ),
			),
			'use_circle_border' => array(
				'label'           => esc_html__( 'Show Circle Border', 'spellolite' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'Here you can choose whether if the icon circle border should display.', 'spellolite' ),
			),
			'circle_border_color' => array(
				'label'       => esc_html__( 'Circle Border Color', 'spellolite' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle border.', 'spellolite' ),
			),
			'animation' => array(
				'label'           => esc_html__( 'Icon Animation', 'spellolite' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'top'    => esc_html__( 'Top To Bottom', 'spellolite' ),
					'left'   => esc_html__( 'Left To Right', 'spellolite' ),
					'right'  => esc_html__( 'Right To Left', 'spellolite' ),
					'bottom' => esc_html__( 'Bottom To Top', 'spellolite' ),
					'off'    => esc_html__( 'No Animation', 'spellolite' ),
				),
				'description'     => esc_html__( 'This controls the direction of the lazy-loading animation.', 'spellolite' ),
			),
			'icon_orientation' => array(
				'label'           => esc_html__( 'Icon Orientation', 'spellolite' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
				...
				'description'     => esc_html__( 'This will control how your icon is aligned.', 'spellolite' ),
			),
			'use_icon_font_size' => array(
				'label'           => esc_html__( 'Use Icon Font Size', 'spellolite' ),
				'type'            => 'yes_no_button',
			...
			'icon_font_size' => array(
				'label'           => esc_html__( 'Icon Font Size', 'spellolite' ),
				'type'            => 'range',
				'option_category' => 'font_option',
				'tab_slug'        => 'advanced',
				'default'         => '50px',
			...
			'circle_size' => array(
				'label'           => esc_html__( 'Circle Size', 'spellolite' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '100',
				...
				'description'     => esc_html__( 'Here you can define a custom diameter for the icon circle.', 'spellolite' ),
				'mobile_options'  => true,
				'depends_default' => true,
			),
			'circle_border_width' => array(
				'label'           => esc_html__( 'Circle Border Width', 'spellolite' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '2',
				...
				'description'     => esc_html__( 'Here you can define a custom width for the icon circle border.', 'spellolite' ),
				'depends_default' => true,
			),
			...
			'disabled_on' => array(
				'label'           => esc_html__( 'Disable on', 'spellolite' ),
				'type'            => 'multiple_checkboxes',
				'options'         => tm_pb_media_breakpoints(),
				'additional_att'  => 'disable_on',
				'option_category' => 'configuration',
				'description'     => esc_html__( 'This will disable the module on selected devices', 'spellolite' ),
			),
			'admin_label' => array(
				'label'       => esc_html__( 'Admin Label', 'spellolite' ),
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the module in the builder for easy identification.', 'spellolite' ),
			),
			'module_id' => array(
				'label'           => esc_html__( 'CSS ID', 'spellolite' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
			...
			'module_class' => array(
				'label'           => esc_html__( 'CSS Class', 'spellolite' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
				'option_class'    => 'tm_pb_custom_css_regular',
...
new Spellolite_Builder_Module_Icon;
