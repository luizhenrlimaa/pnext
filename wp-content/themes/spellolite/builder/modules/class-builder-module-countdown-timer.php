...
/**
 * Class Spellolite_Builder_Module_Countdown_Timer.
 */
class Spellolite_Builder_Module_Countdown_Timer extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Countdown Timer', 'spellolite' );
		...
		$this->advanced_options = array(
			'fonts' => array(
				'header' => array(
					'label'    => esc_html__( 'Header', 'spellolite' ),
					'css'      => array(
						'main' => "{$this->main_css_element} h4",
					),
				),
				'numbers' => array(
					'label'    => esc_html__( 'Numbers', 'spellolite' ),
					'css'      => array(
				...
				'label' => array(
					'label'    => esc_html__( 'Label', 'spellolite' ),
					'css'      => array(
		...
		$this->custom_css_options = array(
			'container' => array(
				'label'    => esc_html__( 'Container', 'spellolite' ),
			...
			'timer_section' => array(
				'label'    => esc_html__( 'Timer Section', 'spellolite' ),
				'selector' => '.section',
			),
		);
	}
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				'label'           => esc_html__( 'Countdown Timer Title', 'spellolite' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'This is the title displayed for the countdown timer.', 'spellolite' ),
			),
			'date_time' => array(
				'label'           => esc_html__( 'Countdown To', 'spellolite' ),
				'type'            => 'date_picker',
				'option_category' => 'basic_option',
				'description'     => tm_get_safe_localization(
					sprintf(
						...
						esc_html__( 'This is the date the countdown timer is counting down to. Your countdown timer is based on your timezone settings in your ', 'spellolite' ),
						esc_html__( 'WordPress General Settings', 'spellolite' )
					)
				),
			),
			'use_background_color' => array(
				'label'           => esc_html__( 'Use Background Color', 'spellolite' ),
				'type'            => 'yes_no_button',
				...
				'description' => esc_html__( 'Here you can choose whether background color setting below should be used or not.', 'spellolite' ),
			),
			'background_color' => array(
				'label'             => esc_html__( 'Background Color', 'spellolite' ),
				'type'              => 'color-alpha',
				'depends_default'   => true,
				'description'       => esc_html__( 'Here you can define a custom background color for your countdown timer.', 'spellolite' ),
			),
			'timer_layout' => array(
				'label'             => esc_html__( 'Layout', 'spellolite' ),
				'type'              => 'select',
				'options'           => array(
					'flat'   => esc_html__( 'Flat', 'spellolite' ),
					'circle' => esc_html__( 'Circle', 'spellolite' ),
				),
				'affects'           => array(
			...
			'circle_background' => array(
				'label'               => esc_html__( 'Circle Background Color', 'spellolite' ),
				'type'                => 'color-alpha',
			...
			'use_circle_border' => array(
				'label'           => esc_html__( 'Use Circle Border', 'spellolite' ),
				'type'            => 'yes_no_button',
...
new Spellolite_Builder_Module_Countdown_Timer;
