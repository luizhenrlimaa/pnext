...
<div class="<?php echo tm_builder_tools()->get_col_classes( $this ); ?>">
	<div class="tm-posts_item">
		...
		<?php
			tm_builder_core()->utility()->attributes->get_title( apply_filters( 'spellolite_module_post_title_settings_layout_2', array(
				'visible'      => true,
				'trimmed_type' => 'word',
				'ending'       => '&hellip;',
		...
		<?php
			...
			tm_builder_core()->utility()->attributes->get_button( apply_filters( 'spellolite_module_post_btn_settings_layout_2', array(
				'visible'   => false,
